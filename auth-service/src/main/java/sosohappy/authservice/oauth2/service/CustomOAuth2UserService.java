...
import sosohappy.authservice.oauth2.CustomOAuth2User;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        System.out.println("oAuth2User1.getAttributes() = " + oAuth2User.getAttributes());
    ...
    private String getProvider(String registrationId) {
        System.out.println("CustomOAuth2UserService.getProvider");
    ...
    private User getUser(OAuthAttributes attributes, String provider) {
        System.out.println("CustomOAuth2UserService.getUser");
        User findUser = userRepository.findByProviderAndProviderId(
                provider,
                attributes.getUserInfo().getProviderId()
        ).orElse(null);
    ...
    private User saveUser(OAuthAttributes attributes, String provider) {
        User createdUser = attributes.toEntity(provider, attributes.getUserInfo());
